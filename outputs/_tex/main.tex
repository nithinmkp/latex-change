...
\subsection{bibliography:
references.bib}\label{bibliography-references.bib-1}
...
the descriptive statistics of the data collected from CPHS\footnote{The
  ...
  pessimistic households, and the corresponding decline in the
  proportion of optimistic households as depicted in the lower panel of
  ...
  statistics to give a graphical representation of the pessimistic
  impact of Covid-19 on the psyche of Indian households. For details,
  see \textbf{?@fig-ics} and the discussion in \textbf{?@sec-4}.}. Using
this data, and by using the methodology described below, we calculate
two types of expenditure minimizing consumption bundles for the Indian
households -- (i) food bundle: consisting of the 8 food groups mentioned
above; and (ii) food \& fuel bundle: consisting of the fuel \& lighting
along with the 8 food groups mentioned above.
...
\subsection{bibliography:
references.bib}\label{bibliography-references.bib-2}
...
we refer to \textbf{?@fig-mean\_educ} for the cross-sectional
heterogeneity of average aggregate inflation rate, and household
specific inflation rate - households classified in terms of educational
